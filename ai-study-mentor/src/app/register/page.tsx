  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      <div className="px-8 py-6 mt-4 text-left bg-white shadow-lg dark:bg-gray-800 rounded-lg">
        <h1 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Registrera ny användare</h1>
        <form onSubmit={handleSubmit}>
          <div className="mt-4">
            <div>
              <label className="block text-gray-700 dark:text-gray-200" htmlFor="name">Namn</label>
              <input
                type="text"
            ...
            <div className="mt-4">
              <label className="block text-gray-700 dark:text-gray-200" htmlFor="password">Lösenord</label>
              <input
                type="password"
