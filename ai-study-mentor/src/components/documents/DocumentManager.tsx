...
export default function DocumentManager() {
  ...
  const fetchDocuments = async () => {
    try {
      ...
      setError(error instanceof Error ? error.message : 'Ett fel uppstod vid hämtning av dokument');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Välj ett dokument för att starta en studiesession med AI-genererade frågor.
        </p>
      </div>
      ...
      {loading && (
        <div className="flex items-center justify-center py-12">
          ...
          <span className="text-gray-600 dark:text-gray-400">Laddar dokument...</span>
        </div>
      )}
      ...
      {!loading && !error && documents.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Du har inte laddat upp några dokument än. Ladda upp ett dokument för att börja studera.
          </p>
          <button
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                    <p className="mb-1">
                      <span className="font-medium">Typ:</span> {document.fileType.toUpperCase()}
                    </p>
                    <p>
                      <span className="font-medium">Uppladdad:</span> {formatDate(document.uploadDate)}
                    </p>
                  </div>
                  <button
