...
export default function MainContent({
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorMessage: Message = {
        ...
        type: "ai",
        content:
          "Ursäkta, något gick fel när jag försökte svara på din fråga. Försök igen eller kontakta support om problemet kvarstår.",
        timestamp: new Date(),
      };
  ...
  const handleUploadSuccess = (document: UploadedDocument) => {
    setUploadSuccess(
      `Dokument "${document.fileName}" har laddats upp och bearbetats!`
    );
    setUploadError(null);
            ...
            <span className="flex items-center gap-2">
              ...
              >
                <path
                  ...
                  strokeWidth={2}
                  d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.418 8-9.879 8-1.171 0-2.292-.192-3.245-.529L3 21l1.529-4.876C4.192 15.292 4 14.171 4 13c0-4.418 4.418-8 9.879-8C18.418 4 21 7.582 21 12z"
                />
              </svg>
              AI Chat
            </span>
              ...
              {messages.length <= 1 && (
                <div className="text-center py-8 mb-6">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mb-8">
                    Ladda upp dokument och ställ frågor för att få studiehjälp
                    på svenska
                  </p>
                ...
                {messages.map((message) => (
                  ...
                  >
                    ...
                    `}
                      ...
                      {/* Message metadata */}
                      <div
                        className={`flex items-center mt-1 px-2 text-xs text-gray-500 dark:text-gray-400 ${
                          message.type === "user"
                            ? "justify-end ml-4"
                            : "justify-start mr-4"
                        }`}
                      >
                        ...
                        {message.type === "ai" &&
                          ...
                          message.sources.length > 0 && (
                            ...
                            >
                              {message.sources.length} källa
                              {message.sources.length > 1 ? "r" : ""}
                            </button>
                          )}
                      </div>
